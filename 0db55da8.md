...
Dhall's `input` requires IO in order to resolve imports. However, it is common when using <6a0a4328?cf> to not want to support imports in application configuration[^sec].
