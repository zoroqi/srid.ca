...
:::{.ui .message}
**Update** (Aug 20): I've decided go back to local development, as well as host my non-critical web apps at a home machine, exposed to the world via [Wireguard](https://nixos.wiki/wiki/Wireguard). I might write about this setup in a separate note.
:::
