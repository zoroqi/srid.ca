...
We will not work directly with GHCJS, however, and instead will use the [[2012405]] library, through the excellent [[2012403]] full-stack framework.
...
You will notice that Obelisk uses [[2017102]] to build your project. The command `ob run` (described below) will abstract over the Nix stuff, including any GHCi handling, so you do not have to deal directly with Nix except for overriding dependencies.
